...
def menu_settings():
    print("\nNote: Currently, we have some bugs in menu settings, so you can change only these settings by manually: Logs Creator, password length and Saved my password in Excel. This issue will be solved in coming future updates")
    ...
    print("Special Characters Allow : " + str(pgs.default_values("special_characters")))
    print("Lowercase Allow : " + str(pgs.default_values("lowercase_allowed")))
    print("Uppercase Allow : " + str(pgs.default_values("uppercase_allowed")))
    print("Alpha Numeric Allow : " + str(pgs.default_values("alpha_numeric_allowed")))
